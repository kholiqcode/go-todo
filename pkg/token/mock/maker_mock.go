...
import (
	...
	token "github.com/kholiqcode/go-todolist/pkg/token"
)
...
func (m *MockMaker) CreateToken(params token.PayloadParams, duration time.Duration) (string, *token.Payload, error) {
	m.ctrl.T.Helper()
...
func (m *MockMaker) VerifyToken(tokenStr string) (*token.Payload, error) {
	m.ctrl.T.Helper()
